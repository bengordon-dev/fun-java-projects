    ...
    public void setImage()
    {
        ...
        iv.setOnMouseClicked( e -> {
            if (e.getButton() != MouseButton.SECONDARY) { // left click
                ...
                this.draw();
                grid.level.unflaggedMines.setText(Integer.toString(grid.unflaggedMines));

            }
        });
        iv.setFitWidth(grid.level.tileSize);
        iv.setFitHeight(grid.level.tileSize);
